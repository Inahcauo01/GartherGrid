            ...
            <div class="overflow-x-auto rounded shadow dark:bg-transparent bg-white">
              <table id="example" class="w-full table-auto display dark:bg-primary-100" style="width: 100%;">
                <thead class="bg-lightGray-50">
                  <th class="px-6 py-4 font-medium dark:text-gray-400">name</th>
                  <th class="px-6 py-4 font-medium dark:text-gray-400">date</th>
                  <th class="px-6 py-4 font-medium dark:text-gray-400">location</th>
                  <th class="px-6 py-4 font-medium dark:text-gray-400">description</th>
                  <th class="px-6 py-4 font-medium dark:text-gray-400">category</th>
                  ...
                  <tr class="border-b border-gray-200 dark:border-gray-800">
                    <td class="flex items-center px-6 py-3 font-medium">
                      <div class="flex">
                          ...
                          <p class="text-xs text-gray-500 dark:text-gray-500">${event.date}</p>
                      </div>
                    </td>
                    <td class="px-6 text-sm font-medium dark:text-gray-400">${event.location}</td>
                    <td class="px-6 text-sm font-medium dark:text-gray-400">${event.description}</td>
                    <td class="px-6 text-sm font-medium dark:text-gray-400">
                      <span class="inline-block px-2 py-1 text-blue-700 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-gray-400">
                          ${event.category}
                      </span>
                    </td>
                    <td class="px-6">
