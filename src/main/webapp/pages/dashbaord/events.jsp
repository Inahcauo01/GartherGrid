...
<%--                                            </form>--%>
                                            <button data-modal-target="edit-modal" data-modal-toggle="edit-modal" data-event-id="${event.id}" class="px-4 py-2 mr-2 text-sm text-gray-600 bg-gray-200 rounded-md dark:bg-gray-600 dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-gray-300" onclick="editEvent(${event.id}, ${event.name}, ${event.description}, ${event.location}, ${event.date}, ${event.hour}, ${event.nbrStandard}, ${event.nbrVIP}, ${event.category.name})">Edit</button>
