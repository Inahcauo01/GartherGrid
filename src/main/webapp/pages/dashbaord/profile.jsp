        ...
        <div class="body-content" x-data="{ open: true }">
            ...
            <div class="relative lg:block navbar-menu">
                <nav x-bind:class="! open ? 'hidden' : 'w-[280px]'"
                    class="fixed top-0 transition-all lg:mt-0 z-40 mt-16 left-0 dark:bg-primary-100 bottom-0 flex  flex-col w-[280px] lg:border-none border-r border-gray-200 dark:border-primary-50 bg-gray-50 overflow-hidden "
                    id="sidenav">
                        ...
                        <ul class="mb-8 text-sm">
                            ...
                            <li>
                                <a href="#"
                                    ...
                                    <span> Products </span>
                                    <span
                                        class="flex items-center justify-center w-6 h-6 px-2 ml-auto text-xs text-indigo-600 bg-indigo-100 rounded dark:group-hover:bg-gray-900 dark:bg-gray-700 dark:text-gray-100">5</span>
                                </a>
                            </li>
                            <li x-data="{ open: false }">
                                <a href="#" @click="open = ! open"
            ...
            <div class="mx-auto transition-all content-wrapper" id="dash"
                ...
                <!-- navbar -->
                <section
                    class="sticky top-0 z-40 px-3 py-3 bg-white shadow dark:text-gray-100 dark:bg-primary-100 lg:px-5">
                    <nav class="relative">
                        <div class="flex items-center justify-between">
                            <div>
                                <button x-on:click="open = ! open"
                                    class="px-2 py-3 border border-primary-50 text-blue-500 bg-blue-100 rounded dark:text-gray-400 dark:bg-primary-100">
                            ...
                            <div class="flex items-center">
                                <div class="justify-center hidden mr-4 md:flex">
                                    <div class=" xl:w-96">
                                        <div class="relative flex flex-wrap items-center w-full ">
                                            <input type="search" name="search"
                                                class="form-control border border-primary-50 relative flex-auto min-w-0 block w-72 px-3 py-1.5 text-base font-normal text-gray-700 bg-white  dark:text-gray-100  border-solid transition ease-in-out m-0 focus:text-gray-700 focus:bg-white dark:bg-primary-100  focus:border-b focus:outline-none"
                                                placeholder="Search">
                                            <button
                                                class="btn i px-6 py-2.5 bg-blue-600 dark:bg-second-100 dark:hover:bg-gray-700 dark:hover:text-white dark:text-gray-900 text-white font-medium text-xs leading-tight uppercase shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center"
                                ...
                                <div class="relative text-left lg:inline-block" x-data="{ open: false }">
                                    <div class="lg:block" @click="open = ! open">
                                        <button class="flex items-center">
                                            <div class="hidden mr-3 text-right md:block">
                                                <p class="text-sm font-bold text-black dark:text-gray-400"> John Doe
                                                </p>
                                            </div>
                                            <div class="mr-2">
                                    ...
                                    <div x-show="open" id="dropdown_profile"
                                        class="absolute right-0 w-48 mt-3 origin-top-right bg-white rounded shadow dark:bg-primary-100 dark:text-gray-100 border border-primary-50"
                                        style="display: none;">
                                        <div class="py-1">
                                            <a href="#"
